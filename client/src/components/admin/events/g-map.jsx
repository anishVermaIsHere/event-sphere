...
export default function GoogleMaps({ register }) {
  ...
  if (typeof window !== 'undefined') {
    if (!document.querySelector('#google-maps')) {
      ...
      const script = loadScript(
        `https://maps.googleapis.com/maps/api/js?key=${AppConfig.google.map.apiKey}&libraries=places&loading=async&callback=${GOOGLE_NAMESPACE}.${callbackId}`,
